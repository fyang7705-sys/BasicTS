...
from src.basicts.metrics import masked_mse
from src.basicts.runners.callback import EarlyStopping, GradientClipping

# 使用自定义数据集：支持 (S,T,F)
from src.basicts.data.hpibt_dataset import HybridPIBTDataset

# 使用 STGCN
from src.basicts.models.STGCN import STGCN, STGCNConfig
...
def main():
    ...
    data = np.load("../../data/traffic_flow/den520d_lifelong/robot1000/train_data.npy")
    print(data.shape)
    print(data[:1])
    ...
    for input_len in [12, 24, 48, 96]:
        for output_len in [12, 24, 48, 96]:
            ...
            BasicTSLauncher.launch_training(BasicTSForecastingConfig(
                ...
                data_file_path="../../data/traffic_flow/den520d_lifelong/robot1000",
